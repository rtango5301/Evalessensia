...
const selectTriggerVariants = cva(
  'flex w-full items-center justify-between gap-2 whitespace-nowrap rounded-md text-sm transition-all outline-none disabled:cursor-not-allowed disabled:opacity-50 data-[placeholder]:text-muted-foreground [&>span]:line-clamp-1',
  {
    variants: {
      variant: {
        default:
          'border border-input bg-transparent shadow-xs focus:border-ring focus:ring-ring/50 focus:ring-[3px]',
        outline: 'border border-[var(--border)] bg-white hover:bg-[var(--bg-subtle)]',
      },
      size: {
