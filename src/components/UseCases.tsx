    ...
    <div className="bg-white border border-[var(--ui-border)] rounded-xl overflow-hidden shadow-lg">
      ...
      <div className="p-5">
        ...
        <div className="flex items-center justify-between mb-4 p-2.5 bg-gray-50 rounded-lg">
          <div>
            <p className="text-[9px] font-semibold text-[var(--text-muted)] uppercase tracking-wider">Target Task</p>
          ...
          >
            <motion.span animate={{ x: [0, 2, 0] }} transition={{ duration: 0.8, repeat: Infinity }}>▶</motion.span> 
            Trigger Evaluation
          </motion.button>
        </div>
        ...
        <div className="border border-[var(--border-light)] rounded-lg overflow-hidden mb-4 relative">
          <div className="flex items-center justify-between px-2 py-1.5 border-b border-gray-100 bg-white">
            <div className="flex items-center gap-3">
              ...
              <div className="flex gap-2 text-[9px] text-[var(--text-muted)]">
                <span>BOOK</span><span>CHECK-IN</span><span>MY TRIPS</span>
              </div>
            </div>
          ...
          <div className="flex items-center gap-1.5 px-2 py-1.5 bg-gray-50">
            <div className="flex-1 px-2 py-1 bg-white rounded border text-[9px]">New York (JFK)</div>
            <div className="flex-1 px-2 py-1 bg-white rounded border text-[9px]">Los Angeles (LAX)</div>
            <div className="px-2 py-1 bg-white rounded border text-[9px]">Oct 27</div>
            <button className="px-2 py-1 bg-[#0ea5e9] text-white rounded text-[9px] font-semibold">SEARCH</button>
          </div>
          
          <div className="p-2 bg-white relative">
            <p className="text-[9px] font-semibold text-[var(--text-muted)] mb-1.5">9 FLIGHTS FOUND</p>
            <div className="flex items-center justify-between p-1.5 border border-[var(--primary)]/30 rounded bg-[var(--primary)]/5 mb-1.5">
              <div className="flex items-center gap-2">
                <div className="w-6 h-6 bg-red-500 rounded flex items-center justify-center text-white text-[8px] font-bold">AL</div>
                <div>
            ...
            >
              <motion.span animate={{ rotate: 360 }} transition={{ duration: 1, repeat: Infinity, ease: "linear" }} className="text-[var(--primary)] text-sm">↻</motion.span>
            ...
            <div className="flex items-center justify-between p-1.5 border border-gray-100 rounded opacity-50">
              <div className="flex items-center gap-2">
                <div className="w-6 h-6 bg-blue-600 rounded flex items-center justify-center text-white text-[8px] font-bold">UA</div>
                <div>
          ...
          >
            ...
            <div className="space-y-0.5">
              <div className="flex items-center gap-1 text-[var(--accent-green)]"><Check className="w-2.5 h-2.5" /> Click: Search</div>
              <div className="flex items-center gap-1 text-[var(--accent-green)]"><Check className="w-2.5 h-2.5" /> Type: "NYC"</div>
              <div className="flex items-center gap-1 text-[var(--primary)]">
                <motion.span animate={{ rotate: 360 }} transition={{ duration: 1, repeat: Infinity, ease: "linear" }}>◎</motion.span> Analyzing...
              </div>
            </div>
          </motion.div>
        </div>
        ...
        <div className="mb-4">
          <div className="flex items-center justify-between mb-1.5">
            <p className="text-[9px] font-semibold text-[var(--text-muted)] uppercase tracking-wider">Evaluation Pipeline</p>
            <span className="text-[9px] text-[var(--text-muted)]">Stage 2/3</span>
          </div>
          <div className="flex gap-0.5 mb-1">
            <motion.div initial={{ width: 0 }} animate={{ width: "100%" }} transition={{ duration: 0.5 }} className="h-1 bg-[var(--accent-green)] rounded-full flex-1" />
            <motion.div initial={{ width: 0 }} animate={{ width: "100%" }} transition={{ duration: 0.5, delay: 0.2 }} className="h-1 bg-[var(--primary)] rounded-full flex-1 relative overflow-hidden">
              <motion.div animate={{ x: ['-100%', '100%'] }} transition={{ duration: 1, repeat: Infinity }} className="absolute inset-0 bg-gradient-to-r from-transparent via-white/40 to-transparent" />
            </motion.div>
        ...
        <div className="grid grid-cols-3 gap-2">
          {[
            ...
            >
              <p className="text-[8px] font-semibold text-[var(--text-muted)] uppercase mb-0.5">{metric.label}</p>
              <p className="text-base font-bold" style={{ color: metric.color }}>
                {metric.value}
                {metric.extra && <span className="text-[var(--accent-green)] text-xs ml-0.5">{metric.extra}</span>}
              </p>
            </motion.div>
          ))}
        </div>
...
function DataAgentScreen() {
  const sqlLines = [
    { num: 1, code: <><span className="text-[#c678dd]">SELECT</span></> },
    { num: 2, code: <>  u.user_id,</> },
    { num: 3, code: <>  <span className="text-[#61afef]">SUM</span>(o.order_total) <span className="text-[#c678dd]">as</span> ltv</> },
    { num: 4, code: <><span className="text-[#c678dd]">FROM</span> users u</> },
    { num: 5, code: <><span className="text-[#c678dd]">JOIN</span> orders o <span className="text-[#c678dd]">ON</span> u.id = o.user_id</> },
    { num: 6, code: <><span className="text-[#c678dd]">WHERE</span> u.signup_date <span className="text-[#c678dd]">BETWEEN</span> <span className="text-[#98c379]">'2024-01-01'</span></> },
    { num: 7, code: <>  <span className="text-[#c678dd]">AND</span> <span className="text-[#98c379]">'2024-01-31'</span></> },
    { num: 8, code: <><span className="text-[#c678dd]">GROUP BY</span> <span className="text-[#d19a66]">1</span></> },
    { num: 9, code: <><span className="text-[#c678dd]">ORDER BY</span> ltv <span className="text-[#c678dd]">DESC</span>;</> },
    { num: 10, code: <></> },
  ];
  ...
  return (
    <div className="bg-white border border-[var(--ui-border)] rounded-xl overflow-hidden shadow-lg">
      ...
      <div className="p-5">
        {/* Input Query */}
        <div className="mb-4">
          <p className="text-[9px] font-semibold text-[var(--text-muted)] uppercase tracking-wider mb-1">Input Query</p>
        ...
        <div className="grid grid-cols-[1.1fr_0.9fr] gap-3 mb-3">
          {/* Generated Script */}
          <div>
            <p className="text-[9px] font-semibold text-[var(--text-muted)] uppercase tracking-wider mb-1.5">Generated Script</p>
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
          ...
          {/* Evaluation Metrics */}
          <div>
            <p className="text-[9px] font-semibold text-[var(--text-muted)] uppercase tracking-wider mb-1.5">Evaluation Metrics</p>
        ...
        <div className="mb-3">
          ...
          <div className="bg-gray-50 rounded-lg p-2.5 border border-gray-100">
            <div className="h-12 relative">
              ...
              <div className="absolute bottom-0 left-0 text-[7px] text-[var(--text-muted)]">LTV ($)</div>
            </div>
        ...
        >
          <div className="flex items-start gap-2">
            ...
            >✓</motion.span>
            <div>
              <p className="text-[9px] font-semibold text-[var(--primary)] uppercase mb-0.5">Summary</p>
              <p className="text-[9px] text-[var(--text-secondary)] leading-relaxed">
                The agent correctly identified the users and orders tables, applied the right date filter for January 2024, and calculated a descending LTV ranking as requested.
              </p>
            </div>
          </div>
        </motion.div>
...
function SupportAgentScreen() {
  const scorecard = [
    { metric: 'Accuracy', desc: 'Policy adherence', control: '92%', candidate: '98%', delta: '+6.5%', positive: true },
    { metric: 'Latency', desc: 'Time to first token', control: '1.2s', candidate: '0.8s', delta: '-33.3%', positive: true },
    { metric: 'Cost', desc: 'Per 1k requests', control: '$0.15', candidate: '$0.18', delta: '+20.0%', positive: false },
    { metric: 'Safety', desc: 'Bias & toxicity filter', control: '99.1%', candidate: '99.3%', delta: '+0.2%', positive: true },
    { metric: 'Efficiency Score', desc: 'Aggregate weighted score', control: '84/100', candidate: '94/100', delta: 'Significant Gain', positive: true, highlight: true },
  ];
  ...
  return (
    <div className="bg-white border border-[var(--ui-border)] rounded-xl overflow-hidden shadow-lg">
      ...
      <div className="flex items-center justify-between px-4 py-2 bg-[var(--ui-header)] border-b border-[var(--ui-border)]">
        ...
        <span className="text-[10px] font-medium text-[var(--text-secondary)]">A/B EVALUATION DASHBOARD</span>
        <span className="text-[9px] font-mono text-[var(--text-muted)] bg-gray-100 px-1.5 py-0.5 rounded">ID: #BCH-4820</span>
      </div>
      ...
      <div className="p-5">
        ...
        <div className="grid grid-cols-2 gap-2 mb-3 relative">
          ...
          >
            <div className="flex items-center justify-between mb-1.5">
              <p className="text-[8px] text-[var(--text-muted)] uppercase tracking-wide">Agent Version</p>
              <span className="text-[7px] bg-gray-100 text-gray-600 px-1.5 py-0.5 rounded font-semibold uppercase">Control</span>
            </div>
            <p className="text-[11px] font-bold mb-1.5">Stable v1.0.4</p>
            <p className="text-[8px] text-[var(--text-muted)] uppercase tracking-wide mb-1">Output Response</p>
            <p className="text-[9px] text-[var(--text-secondary)] leading-relaxed">
              "I'm sorry to hear you're unhappy with your purchase. I completely understand how frustrating that can be. I'd be happy to help process a refund for you."
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="flex items-center justify-between mb-1.5">
              <p className="text-[8px] text-[var(--accent-green)] uppercase tracking-wide">Agent Version</p>
              <span className="text-[7px] bg-[var(--primary)]/10 text-[var(--primary)] px-1.5 py-0.5 rounded font-semibold uppercase">Candidate</span>
            </div>
            <p className="text-[11px] font-bold text-[var(--accent-green)] mb-1.5">Experimental v1.1.0-rc</p>
            <p className="text-[8px] text-[var(--accent-green)] uppercase tracking-wide mb-1">Output Response</p>
            <p className="text-[9px] text-[var(--text-secondary)] leading-relaxed">
              "I am so incredibly sorry for the frustration this has caused. I have already authorized a full refund and added a $20 credit to your account."
            </p>
          </motion.div>
        </div>
        ...
        <div className="mb-3">
          <p className="text-[9px] font-semibold text-[var(--text-muted)] uppercase tracking-wider mb-1.5">Comparative Scorecard</p>
          <div className="border border-gray-100 rounded-lg overflow-hidden">
            ...
            {scorecard.map((row, idx) => (
              ...
              >
                <div>
                  <p className={`text-[9px] font-medium ${row.highlight ? 'text-[var(--accent-green)]' : ''}`}>{row.metric}</p>
                  <p className="text-[7px] text-[var(--text-muted)]">{row.desc}</p>
                </div>
                <span className="text-[9px] text-center">{row.control}</span>
                <span className={`text-[9px] text-center font-semibold ${row.highlight ? 'text-[var(--primary)]' : ''}`}>{row.candidate}</span>
                <span className={`text-[8px] text-right font-semibold ${row.positive ? 'text-[var(--accent-green)]' : 'text-[var(--error)]'} ${row.highlight ? 'bg-[var(--accent-green)]/10 px-1 py-0.5 rounded' : ''}`}>
                  {row.delta}
                </span>
              </motion.div>
            ))}
          ...
          <div className="flex gap-2">
            ...
            >
              <span className="flex items-center gap-1">
                Promote to Production (v1.1.0-rc)
              </span>
            </motion.button>
          </div>
        </div>
...
function ContentAgentScreen() {
  const metrics = [
    { label: 'Task Completion', v1: 95, v2: 100, value: '100%', delta: '+5%', positive: true, color1: 'var(--primary)', color2: 'var(--primary)' },
    { label: 'Accuracy', v1: 100, v2: 98, value: '98%', delta: '-2%', positive: false, color1: 'var(--accent-green)', color2: 'var(--accent-green)' },
    { label: 'Latency', v1: 60, v2: 40, value: '1.2s', delta: '-0.8s', positive: true, color1: '#f59e0b', color2: 'var(--accent-green)' },
    { label: 'Cost (per 1k tokens)', v1: 80, v2: 20, value: '$0.005', delta: '75% cheaper', positive: true, color1: 'var(--primary)', color2: 'var(--primary)' },
    { label: 'Safety', v1: 100, v2: 100, value: '100%', delta: 'Stable', positive: true, color1: 'var(--accent-green)', color2: 'var(--accent-green)' },
    { label: 'Efficiency', v1: 65, v2: 92, value: '92%', delta: '+27%', positive: true, color1: 'var(--primary)', color2: 'var(--primary)' },
  ];
  ...
  return (
    <div className="bg-white border border-[var(--ui-border)] rounded-xl overflow-hidden shadow-lg">
      ...
      <div className="flex items-center gap-2 px-4 py-2 bg-[var(--ui-header)] border-b border-[var(--ui-border)]">
        ...
        <span className="flex-1 text-center text-[10px] font-medium text-[var(--text-secondary)] tracking-wide">CONTENT AGENT EVAL DASHBOARD</span>
      </div>
      
      <div className="p-5">
        {/* Task */}
        <div className="mb-3">
          <span className="text-[9px] text-[var(--text-muted)] uppercase font-semibold tracking-wider">Task: </span>
        ...
        <div className="grid grid-cols-2 gap-2 mb-4">
          ...
          >
            ...
            <p className="text-[9px] text-[var(--foreground)] leading-relaxed mb-2">
              "Introducing Smart Sync - your data, always up to date, everywhere. No more manual exports. Just connect and go. Try it free today. 🚀"
            </p>
          ...
          >
            ...
            <p className="text-[9px] text-[var(--foreground)] leading-relaxed mb-2">
              "Sync your world effortlessly. Smart Sync bridges the gap between your apps, ensuring data flows where you need it, when you need it. ✨ #Efficiency #SmartSync"
            </p>
            ...
            {metrics.map((metric, idx) => (
              ...
              >
                ...
                <div className="text-right">
                  ...
                  <p className={`text-[8px] ${metric.positive ? 'text-[var(--accent-green)]' : 'text-[var(--error)]'}`}>
                    {metric.delta}
                  </p>
                </div>
              </motion.div>
